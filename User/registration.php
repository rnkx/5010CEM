                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <!-- Continue with email, phone, address, country dropdown, city, state, zip, password, confirm password, and submit button similarly -->
                            </div>
                        </div>
                    </form>
                </div>
...
<?php 
// Include footer (closing HTML, scripts)
